...
Scenario: Een patiënt maakt succesvol een afspraak op een beschikbaar tijdslot 
	...
	When patiënt Rawan een afspraak bij dokter Timmermans op 15-05-2026 om 10:30 voor een consultatie
...
Scenario: Een patiënt kan geen afspraak maken op een niet-beschikbaar tijdslot
	...
	When patiënt Rawan een afspraak probeert te maken bij dokter Timmermans op 15-05-2026 om 09:30 voor een consultatie
