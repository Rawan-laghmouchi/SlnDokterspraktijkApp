...
@tag1
Scenario Outline: Een bestand wordt gevalideerd bij het toevoegen aan een afspraakaanvraag
	Given patiënt Sara Peeters heeft een afspraakaanvraag voor een huidprobleem
