...
@tag1
Scenario: De patiënt raadpleegt de tijdsloten van een dokter op een bepaalde dag
	Given dokter Timmermans heeft op 15-07-2026 de volgende tijdsloten:
	| Tijd  | Status           |
	| 09:00 | beschikbaar      |
	| 09:30 | niet beschikbaar |
	| 10:00 | beschikbaar      |
	When patiënt Sara Peeters de tijdsloten van dokter Timmermans op 15-07-2026 raadpleegt
