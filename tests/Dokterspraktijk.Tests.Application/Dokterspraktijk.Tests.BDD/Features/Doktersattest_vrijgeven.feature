...
Scenario: Een dokter geeft een attest vrij na een afgeronde consultatie
	Given dokter Timmermans heeft een afgeronde consultatie met patiënt Rawan Laghmouchi
...
Scenario: Een dokter kan geen attest vrijgeven voor een niet-afgeronde consultatie
	Given dokter Timmermans heeft een geplande consultatie met patiënt Rawan Laghmouchi
